<section class="py-28 bg-[#FFF8F3] relative overflow-hidden">
    <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[1px] bg-gradient-to-r from-transparent via-party-1/40 to-transparent"></div>

    <div class="max-w-6xl mx-auto px-6 lg:px-12">
      <div class="reveal text-center mb-20">
        <span class="inline-block border border-gold/30 text-gold text-xs font-semibold tracking-[0.2em] uppercase px-4 py-1.5 rounded-full mb-5">Simple Process</span>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 relative">
        ...
        <div class="hidden lg:block absolute top-12 left-[20%] right-[20%] h-[2px] bg-gradient-to-r from-party-1/20 via-party-1/60 to-party-1/20"></div>
        {{-- Center mask to cut the line behind the middle step --}}
        <div class="hidden lg:block absolute top-0 left-1/2 -translate-x-1/2 w-24 h-24 rounded-full bg-[#FFF8F3] border border-party-1/10 pointer-events-none"></div>
        ...
        <div class="reveal text-center relative">
          <div class="relative inline-flex items-center justify-center w-24 h-24 mb-6">
            <div class="absolute inset-0  rounded-full border-2 border-party-1/30 bg-white/20"></div>
            <div class="absolute inset-2 rounded-full border border-party-1/20"></div>
